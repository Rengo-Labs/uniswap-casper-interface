      ...
      case AddLiquidityEntryPoint.ADD_LIQUIDITY:
        ...
        return await casperClient.signAndDeployWasm(
          ...
          RuntimeArgs.fromMap({
            ...
            amount_a_min: CLValueBuilder.u256(new BigNumber(amountADesired).times(1 - 1).toFixed(0, BigNumber.ROUND_FLOOR)),
            amount_b_min: CLValueBuilder.u256(new BigNumber(amountBDesired).times(1 - 1).toFixed(0, BigNumber.ROUND_FLOOR)),
