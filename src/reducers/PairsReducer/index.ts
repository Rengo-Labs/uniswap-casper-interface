  ...
  switch (action.type) {
    ...
    case PairActions.APR_REWARDS: {
      ...
      if (!!action.payload.tokenRewardPriceUSD && oldState.gaugeContractHash) {
        ...
        console.log("total liquidity usd", action.payload.totalLiquidityUSD, "/", oldState.totalSupply, "->", pricePerLPToken)
        console.log("total staked", oldState.gaugeTotalStake, "price per LP Token", pricePerLPToken, "->", totalStakeUSD)
        ...
        if (oldState.gaugeToken != null) {
          ...
          console.log("APR -> (", APR_AMOUNT_WEEKS, "/", action.payload.gaugeAmount, ")/", action.payload.totalLiquidityUSD, "* 100 =", globalRewardsAPR)
        ...
        if (oldState.gaugeCSTRewards) {
          ...
          console.log("APR -> ", APR_AMOUNT_WEEKS, "*", oldState.gaugeCSTWeight, "/", action.payload.gaugeTotalWeight, "=", globalRewardsAPR)
