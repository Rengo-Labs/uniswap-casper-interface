...
export const REWARD_TOKEN_WEEKLY_EMISSIONS = process.env.REWARD_TOKEN_WEEKLY_EMISSIONS
export const REWARD_CST_WEEKLY_INFLATION_RATE = process.env.REWARD_CST_WEEKLY_INFLATION_RATE