...
const LiquidityDetail = ({firstSymbol, secondSymbol, maxAmount, firstTotalLiquidity, secondTotalLiquidity, totalSupply, slippage, setSlippage, networkFee, setNetworkFee}) => {
    ...
    return (
        <>
            <LiquidityDetails
                ...
                maxAmount={(formatNaN(maxAmount) * (1 - slippage / 100)).toFixed(9)}
