  ...
  const loadUserLP = () => {
    const userPairs = Object.values(pairState).filter(
      ...
      return {
        ...
        apr: `${i.apr} %`,
        totalStake: !BigNumber(i.gaugeTotalStake).isNaN() ? `$ ${i.gaugeTotalStakeUSD}` : "$ 0.00",
        ...
        lpStaked: parseFloat(i.gaugeBalance) > 0 && !BigNumber(i.gaugeTotalStake).isNaN() ? `$ ${(parseFloat(i.gaugeBalance) * parseFloat(i.gaugeTotalStakeUSD)/parseFloat(i.gaugeTotalStake)).toFixed(2)} (${getStakePercentage(i)})` : '$ 0.00',
